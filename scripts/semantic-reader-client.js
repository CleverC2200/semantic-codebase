(() => {
  ...
  document.addEventListener('click', event => {
    ...
    if (el.dataset.comparisonFunction) { savePosition(); comparison.focus = { key: el.dataset.comparisonFunction, side: el.dataset.comparisonSide }; S.detail = null; render(); $('reading').scrollTop = 0; }
